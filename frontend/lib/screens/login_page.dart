      ...
      child: ElevatedButton(
        onPressed: () {
          if (selectedRole == 'Customer') {
            // Navigate directly to home page after login (for now)
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (_) => const HomePage()),
            );
          } else {
            // Show message for Artist login
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: const Text(
                  "Artist login is currently under development. Please try again later.",
...
// Enhanced ResetPasswordPage with proper UI and functionality
